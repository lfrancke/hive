...
public interface HiveSession extends HiveSessionBase {
   ...
   * @throws HiveSQLException
   */
  OperationHandle getTables(String catalogName, String schemaName, String tableName,
   ...
   * @throws HiveSQLException
   */
  OperationHandle getColumns(String catalogName, String schemaName, String tableName,
  ...
  String getDelegationToken(HiveAuthFactory authFactory, String owner, String renewer)
    throws HiveSQLException;
