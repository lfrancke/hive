...
public interface IMetaStoreClient {
   ...
   */
  Partition exchange_partition(Map<String, String> partitionSpecs, String sourceDb,
   ...
   * @throws TException
   */
  Partition getPartitionWithAuthInfo(String dbName, String tableName, List<String> pvals,
  ...
  List<Partition> listPartitions(String db_name, String tbl_name, List<String> part_vals,
    short max_parts) throws NoSuchObjectException, MetaException, TException;

  List<String> listPartitionNames(String db_name, String tbl_name, short max_parts)
    throws MetaException, TException;

  List<String> listPartitionNames(String db_name, String tbl_name, List<String> part_vals,
    short max_parts)
      throws MetaException, TException, NoSuchObjectException;
   ...
   * @throws TException
   */
  List<Partition> listPartitionsByFilter(String db_name, String tbl_name, String filter,
   ...
   * @throws NoSuchObjectException
   */
  List<Partition> listPartitionsWithAuthInfo(String dbName, String tableName, short s,
    String userName, List<String> groupNames)
      throws MetaException, TException, NoSuchObjectException;
  ...
  List<Partition> listPartitionsWithAuthInfo(String dbName, String tableName,
    List<String> partialPvals, short s, String userName, List<String> groupNames)
    throws MetaException, TException, NoSuchObjectException;
   ...
   *          if error in communicating with metastore server
   */
  void renamePartition(final String dbname, final String name, final List<String> part_vals,
  ...
  PrincipalPrivilegeSet get_privilege_set(HiveObjectRef hiveObject, String user_name,
    List<String> group_names) throws MetaException,
      TException;
   ...
   * @throws TException
   */
  List<HiveObjectPrivilege> list_privileges(String principal_name, PrincipalType principal_type,
